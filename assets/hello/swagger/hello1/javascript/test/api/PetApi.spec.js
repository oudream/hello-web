    ...
    describe('PetApi', function() {
      describe('addPet', function() {
        it('should call addPet successfully', function(done) {
          ...
          /*
          var opts = {};
          opts.body = new SwaggerPetstore.Pet();
          opts.body.id = "0";
          opts.body.category = new SwaggerPetstore.Category();
          opts.body.category.id = "0";
          opts.body.category.name = "";
          opts.body.name = "doggie";
          opts.body.photoUrls = [""];
          opts.body.tags = [new SwaggerPetstore.Tag()];
          opts.body.tags[0].id = "0";
          opts.body.tags[0].name = "";
          opts.body.status = "available";

          instance.addPet(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('updatePet', function() {
        it('should call updatePet successfully', function(done) {
          ...
          instance.updatePet(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
